        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              ...
              infraestrutura atual, criamos escopos detalhados e tiramos seus
              planos do papel.
            </motion.p>
              ...
              {[
                {
                  ...
                  val: "contato@ymsystems.com",
                  icon: Mail,
                },
                {
                  label: "Telefone comercial",
                  val: "+55 (11) 98765-4321",
                  icon: Phone,
                },
                {
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    >
                      <option value="10k-30k" className="bg-bg-elevated">
                        R$ 10k - R$ 30k
                      </option>
                      <option value="30k-60k" className="bg-bg-elevated">
                        R$ 30k - R$ 60k
                      </option>
                      <option value="60k+" className="bg-bg-elevated">
                        R$ 60k+
                      </option>
                    </select>
                  </div>
